<%-- 
    Document   : newjsp
    Created on : 7 oct. 2023, 00:31:19
    Author     : Gonzalo
--%>
...
<html>
    <head>
        ...
        <title>Metereología Web</title>
    </head>
    <body>
        <nav class="navbar navbar-light bg-dark fixed-top">
            <div class="container-fluid">
                <img src="images/icons/hogar.png" width="25" height="25"/> <a class="navbar-brand" href="index.jsp"> <h5 class="home1"> Home</h5></a>
                ...
                <div class="dropdown">
                    ...
                    <a class="btn btn-primary btn-block" aria-current="page" href="Registrar.jsp"><img src="images/icons/registrar.png" width="25" height="25"/> Registrarse</a>
                </div>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <div class="perfil">
                                    <img src="images/icons/signo-de-interrogacion.png" width="200" height="200"/>
                                </div>
                            <h7 class="register">NO REGISTRADO</h7>
                            <h3>-------------------------------</h3>
                            <h5><img src="images/icons/cancelar.png" width="20" height="20"/> USUARIO:</h5><h6> <a>Example</a></h6>
                            <h5><img src="images/icons/cancelar.png" width="20" height="20"/> CORREO:</h5><h6> <a>Example@gmail</a></h6>
                            </li>
                            <h3>-------------------------------</h3>
                            <li class="nav-item">
                                <a class="nav-link" href="">Buscar clima del lugar</a>
                                <a class="nav-link" href="">GoogleMaps</a>
                                <br>
                                <a class="btn btn-dark btn-block" aria-current="page" href="Ingresar.jsp"><img src="images/icons/iniciar-sesion.png" width="25" height="25"/> Iniciar Sesión</a>
                            </li>
                        </ul>
                    </div>
                </div>
